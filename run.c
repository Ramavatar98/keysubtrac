...
int main() {
    ...
    FILE* fp = popen("./keysubtracter -p 02145d2611c823a396ef6712ce0f712f09b9b4f3135e3e0aa3230fb9b6d08d1e16 -n 47112285931760246646623899502532662132736 -b 136 -R", "r");
    if (!fp) {
