...
int main() {
    ...
    FILE* fp = popen("./keysubtracter -p 03a8c204d9e0cd0e7f6da825d55b5c2b9d0093f96650bf37e67bc802189b3bc478 -n 47112285931760246646623899502532662132736 -R -b 136", "r");
    if (!fp) {
